...
class TwtApiDetails(install):
    ...
    def run(self):
        ...
        with open(home + '/.twweet-cli/data/config.yml', 'w') as ymlfile:
            ymlFilecontent = """# Depending on the system (Windows or Linux) change the backward or forward slash appropriately.
Tweets: /TweetsStore/
...
# initialize authentication cache area
...
# set the long description using the README
